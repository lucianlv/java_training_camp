...
//        +" "+componentClass.getSimpleName()+" "+componentClass.getDeclaredFields()
//        );
        ...
        Stream.of(componentClass.getDeclaredFields())
                .filter(field -> {
                    ...
                    boolean f1 = Modifier.isStatic(mods);
                    boolean f2 = field.isAnnotationPresent(Resource.class);
//                    System.out.println("field=" +field+ "  f1="+f1  +"   "+"f2="+f2);
                    return (!f1 && f2);
                }).forEach(field -> {
...
//                );
//
//                System.out.println("field="+injectedObject);
