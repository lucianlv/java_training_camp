...
import static org.geektimes.configuration.microprofile.config.source.servlet.ServletContextConfigInitializer.DEFAULT_CONFIG;
...
public class FrontControllerServlet extends HttpServlet {
    ...
    public void init(ServletConfig servletConfig) {
        testConfig(servletConfig);
        initHandleMethods();
    }

    private void testConfig(ServletConfig servletConfig) {
        Config defaultConfig = (Config) servletConfig.getServletContext().getAttribute(DEFAULT_CONFIG);
        String message = defaultConfig.getValue("message", String.class);

        String value = DefaultConfigProviderResolver.instance().getConfig().getValue("application.name", String.class);
        System.out.println(value);

        Config config = DefaultConfigContext.get();
...
//                    handleMethodInfoMapping.forEach((key,value) ->{
//                        System.out.println("key="+key);
//                        System.out.println("value="+value.getHandlerMethod().getName());
//                    });
