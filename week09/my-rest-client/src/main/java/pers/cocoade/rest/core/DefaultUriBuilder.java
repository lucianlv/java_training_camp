package pers.cocoade.rest.core;
...
import static pers.cocoade.rest.util.PathUtils.buildPath;
import static pers.cocoade.rest.util.PathUtils.resolvePath;
import static pers.cocoade.rest.util.URLUtils.*;
